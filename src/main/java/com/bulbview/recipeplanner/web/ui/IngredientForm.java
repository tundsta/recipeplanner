 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = com.bulbview.recipeplanner.domain.Ingredient.class)
public class IngredientForm extends CustomComponent implements EntityEditor {
